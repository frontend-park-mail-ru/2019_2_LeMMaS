...
class Index extends DefaultView{
    ...
    render()
    {
        ...
        const plateLeaderboard = plate.render("",
            text.render("text__align-center",
                "h2", "Leaderboard"), leaderboard.render());

        const platePlay = plate.render("plate__size-big",
            text.render("text__align-center text__size-big", "h2", "Play"),
            button.render("", "Singleplayer", "button__size-big button__transparency-transparent"),
            button.render("", "Multiplayer", "button__size-big button__color-yellow"),
            button.render("", "Experimental", "button__size-big button__color-red")
        );

        const plateAboutMe = plate.render("", userPicName.render(),
            userAchievement.render("XP", "100"),
            userAchievement.render("Coins", "130"),
            button.render("shop", "Shop", "button__size-big button__color-violet"));
